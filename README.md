...
Current version: **v26.13**

## What changed in v26.13
...
- updated the app notes and synchronized the displayed app version, manifest version, and service-worker cache version to v26.13
...
Latest update: v26.13 adds a persistent in-app version label and a safe service-worker update banner with an explicit Update action.

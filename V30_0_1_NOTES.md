# The Dye Ledger v30.0.3 – Shared Match Assignment Reliability Fix
...
No schema changes were made. v30.0.3 reuses existing tables and stores device identity metadata in the existing `match_memberships.device_label` text field.

...
## Run Metadata
- Version: v30.3.93
- Timestamp: 2026-08-08T02:47:21.613Z
- Seed: dye-ledger-v30.3.93-default
- Random rounds: 100
- Fixtures run: 25
...
- Warning - random_017: Match Play closed on hole 11; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_019: Match Play closed on hole 7; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_023: Match Play closed on hole 12; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_034: Match Play closed on hole 13; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_054: Match Play closed on hole 15; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_062: Match Play closed on hole 15; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_063: Incomplete round has provisional Nassau and settlement output.
- Warning - random_064: Match Play closed on hole 16; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_065: Match Play closed on hole 7; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_074: Incomplete round has provisional Nassau and settlement output.
...
- Warning - random_078: Incomplete round has provisional Nassau and settlement output.
...
- Warning - random_086: Match Play closed on hole 6; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_091: Match Play closed on hole 17; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_100: Match Play closed on hole 15; later entered scores should not change the recorded winner without intentional edit handling.

- Suspicious - blowout_match_play: A settlement row exceeds $100; confirm blowout/wager settings are intentional.
- Suspicious - random_031: A settlement row exceeds $100; confirm blowout/wager settings are intentional.
...
- random_029: 17/18 holes, 2 warning(s), 0 suspicious item(s), settlement Alex pays Drew $22.00; Alex pays Casey $17.00; Alex pays Blake $12.00
- random_031: 18/18 holes, 1 warning(s), 1 suspicious item(s), settlement Alex pays Blake $107.00; Alex pays Drew $2.00; Casey pays Drew $10.00

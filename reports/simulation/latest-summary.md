...
## Run Metadata
- Version: v30.3.46
- Timestamp: 2026-07-08T04:22:12.027Z
- Seed: dye-ledger-v30.3.46-default
- Random rounds: 100
- Fixtures run: 10
...
- Warning - random_001: Match Play closed on hole 7; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_002: Match Play closed on hole 14; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_030: Match Play closed on hole 15; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_033: Match Play closed on hole 8; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_055: Match Play closed on hole 13; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_071: Match Play closed on hole 8; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_072: Match Play closed on hole 16; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_073: Match Play closed on hole 7; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_079: Match Play closed on hole 17; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_087: Match Play closed on hole 16; later entered scores should not change the recorded winner without intentional edit handling.
- Warning - random_088: Incomplete round has provisional Nassau and settlement output.
- Warning - random_089: Match Play closed on hole 12; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_092: Match Play closed on hole 7; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_095: Match Play closed on hole 15; later entered scores should not change the recorded winner without intentional edit handling.
...
- Warning - random_099: Match Play closed on hole 6; later entered scores should not change the recorded winner without intentional edit handling.
...
- random_001: 9/9 holes, 1 warning(s), 0 suspicious item(s), settlement Alex pays Blake $32.00; Alex pays Drew $15.00; Casey pays Drew $8.00
- random_004: 9/9 holes, 1 warning(s), 0 suspicious item(s), settlement Blake pays Alex $54.00; Drew pays Alex $33.00; Drew pays Casey $6.00
...
1. Create an importable competition-engine adapter so simulations can call live app scoring functions directly.

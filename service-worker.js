...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.22&rev=202608312130',
  './app.js?v=31.0.22&rev=202608312130',
  './identity-security.js?v=31.0.22&rev=202608312130',
  './supabase-config.js?v=31.0.22&rev=202608312130',
  './manifest.json?v=31.0.22&rev=202608312130',
  './branding/apple-touch-icon-v31.0.22.png',
  './branding/favicon-32-v31.0.22.png',
  './branding/favicon-16-v31.0.22.png',
  './branding/app-icon-192-v31.0.22.png',
  './branding/app-icon-512-v31.0.22.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.22',
  './ledger-report/pack.js?v=31.0.22',
  './ledger-report/engines.js?v=31.0.22',
  './ledger-report/logic.js?v=31.0.22',
  './ledger-report/report.js?v=31.0.22',

...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.25&rev=202609021100',
  './app.js?v=31.0.25&rev=202609021100',
  './identity-security.js?v=31.0.25&rev=202609021100',
  './supabase-config.js?v=31.0.25&rev=202609021100',
  './manifest.json?v=31.0.25&rev=202609021100',
  './branding/apple-touch-icon-v31.0.25.png',
  './branding/favicon-32-v31.0.25.png',
  './branding/favicon-16-v31.0.25.png',
  './branding/app-icon-192-v31.0.25.png',
  './branding/app-icon-512-v31.0.25.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.25',
  './ledger-report/pack.js?v=31.0.25',
  './ledger-report/engines.js?v=31.0.25',
  './ledger-report/logic.js?v=31.0.25',
  './ledger-report/report.js?v=31.0.25',

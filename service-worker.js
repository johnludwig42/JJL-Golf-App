...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.17&rev=202608292230',
  './app.js?v=31.0.17&rev=202608292230',
  './identity-security.js?v=31.0.17&rev=202608292230',
  './supabase-config.js?v=31.0.17&rev=202608292230',
  './manifest.json?v=31.0.17&rev=202608292230',
  './branding/apple-touch-icon-v31.0.17.png',
  './branding/favicon-32-v31.0.17.png',
  './branding/favicon-16-v31.0.17.png',
  './branding/app-icon-192-v31.0.17.png',
  './branding/app-icon-512-v31.0.17.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.17',
  './ledger-report/pack.js?v=31.0.17',
  './ledger-report/engines.js?v=31.0.17',
  './ledger-report/logic.js?v=31.0.17',
  './ledger-report/report.js?v=31.0.17',

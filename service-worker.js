...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.06&rev=1',
  './app.js?v=31.0.06&rev=1',
  './identity-security.js?v=31.0.06&rev=1',
  './supabase-config.js?v=31.0.06&rev=1',
  './manifest.json?v=31.0.06&rev=1',
  './branding/apple-touch-icon-v31.0.06.png',
  './branding/favicon-32-v31.0.06.png',
  './branding/favicon-16-v31.0.06.png',
  './branding/app-icon-192-v31.0.06.png',
  './branding/app-icon-512-v31.0.06.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.06',
  './ledger-report/pack.js?v=31.0.06',
  './ledger-report/engines.js?v=31.0.06',
  './ledger-report/report.js?v=31.0.06',

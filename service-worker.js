...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.45&rev=202609121200',
  './app.js?v=31.0.45&rev=202609121200',
  './identity-security.js?v=31.0.45&rev=202609121200',
  './supabase-config.js?v=31.0.45&rev=202609121200',
  './manifest.json?v=31.0.45&rev=202609121200',
  './branding/apple-touch-icon-v31.0.45.png',
  './branding/favicon-32-v31.0.45.png',
  './branding/favicon-16-v31.0.45.png',
  './branding/app-icon-192-v31.0.45.png',
  './branding/app-icon-512-v31.0.45.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.45',
  './ledger-report/pack.js?v=31.0.45',
  './ledger-report/engines.js?v=31.0.45',
  './ledger-report/logic.js?v=31.0.45',
  './ledger-report/report.js?v=31.0.45',

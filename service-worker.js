...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.11&rev=202608272000',
  './app.js?v=31.0.11&rev=202608272000',
  './identity-security.js?v=31.0.11&rev=202608272000',
  './supabase-config.js?v=31.0.11&rev=202608272000',
  './manifest.json?v=31.0.11&rev=202608272000',
  './branding/apple-touch-icon-v31.0.11.png',
  './branding/favicon-32-v31.0.11.png',
  './branding/favicon-16-v31.0.11.png',
  './branding/app-icon-192-v31.0.11.png',
  './branding/app-icon-512-v31.0.11.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.11',
  './ledger-report/pack.js?v=31.0.11',
  './ledger-report/engines.js?v=31.0.11',
  './ledger-report/report.js?v=31.0.11',

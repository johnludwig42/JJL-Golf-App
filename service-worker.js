...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.04&rev=4',
  './app.js?v=31.0.04&rev=4',
  './identity-security.js?v=31.0.04&rev=4',
  './supabase-config.js?v=31.0.04&rev=4',
  './manifest.json?v=31.0.04&rev=4',
  ...
  './ledger-report/bootstrap.js?v=31.0.04&rev=4',
  './ledger-report/pack.js?v=31.0.04&rev=4',
  './ledger-report/engines.js?v=31.0.04&rev=4',
  './ledger-report/report.js?v=31.0.04&rev=4',

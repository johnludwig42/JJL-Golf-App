...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.13&rev=202608281800',
  './app.js?v=31.0.13&rev=202608281800',
  './identity-security.js?v=31.0.13&rev=202608281800',
  './supabase-config.js?v=31.0.13&rev=202608281800',
  './manifest.json?v=31.0.13&rev=202608281800',
  './branding/apple-touch-icon-v31.0.13.png',
  './branding/favicon-32-v31.0.13.png',
  './branding/favicon-16-v31.0.13.png',
  './branding/app-icon-192-v31.0.13.png',
  './branding/app-icon-512-v31.0.13.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.13',
  './ledger-report/pack.js?v=31.0.13',
  './ledger-report/engines.js?v=31.0.13',
  './ledger-report/logic.js?v=31.0.13',
  './ledger-report/report.js?v=31.0.13',

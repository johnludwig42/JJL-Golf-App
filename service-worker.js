...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.04&rev=2',
  './app.js?v=31.0.04&rev=2',
  './identity-security.js?v=31.0.04&rev=2',
  './supabase-config.js?v=31.0.04&rev=2',
  './manifest.json?v=31.0.04&rev=2',
  ...
  './ledger-report/bootstrap.js?v=31.0.04&rev=2',
  './ledger-report/pack.js?v=31.0.04&rev=2',
  './ledger-report/engines.js?v=31.0.04&rev=2',
  './ledger-report/report.js?v=31.0.04&rev=2',

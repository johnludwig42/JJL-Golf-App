...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.15&rev=202608291715',
  './app.js?v=31.0.15&rev=202608291715',
  './identity-security.js?v=31.0.15&rev=202608291715',
  './supabase-config.js?v=31.0.15&rev=202608291715',
  './manifest.json?v=31.0.15&rev=202608291715',
  './branding/apple-touch-icon-v31.0.15.png',
  './branding/favicon-32-v31.0.15.png',
  './branding/favicon-16-v31.0.15.png',
  './branding/app-icon-192-v31.0.15.png',
  './branding/app-icon-512-v31.0.15.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.15',
  './ledger-report/pack.js?v=31.0.15',
  './ledger-report/engines.js?v=31.0.15',
  './ledger-report/logic.js?v=31.0.15',
  './ledger-report/report.js?v=31.0.15',

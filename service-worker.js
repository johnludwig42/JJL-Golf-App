...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.04&rev=5',
  './app.js?v=31.0.04&rev=5',
  './identity-security.js?v=31.0.04&rev=5',
  './supabase-config.js?v=31.0.04&rev=5',
  './manifest.json?v=31.0.04&rev=5',
  ...
  './ledger-report/bootstrap.js?v=31.0.04&rev=5',
  './ledger-report/pack.js?v=31.0.04&rev=5',
  './ledger-report/engines.js?v=31.0.04&rev=5',
  './ledger-report/report.js?v=31.0.04&rev=5',

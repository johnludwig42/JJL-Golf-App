...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.33&rev=202609020613',
  './app.js?v=31.0.33&rev=202609020613',
  './identity-security.js?v=31.0.33&rev=202609020613',
  './supabase-config.js?v=31.0.33&rev=202609020613',
  './manifest.json?v=31.0.33&rev=202609020613',
  './branding/apple-touch-icon-v31.0.33.png',
  './branding/favicon-32-v31.0.33.png',
  './branding/favicon-16-v31.0.33.png',
  './branding/app-icon-192-v31.0.33.png',
  './branding/app-icon-512-v31.0.33.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.33',
  './ledger-report/pack.js?v=31.0.33',
  './ledger-report/engines.js?v=31.0.33',
  './ledger-report/logic.js?v=31.0.33',
  './ledger-report/report.js?v=31.0.33',

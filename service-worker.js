...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.04&rev=1',
  './app.js?v=31.0.04&rev=1',
  './identity-security.js?v=31.0.04&rev=1',
  './supabase-config.js?v=31.0.04&rev=1',
  './manifest.json?v=31.0.04&rev=1',
  ...
  './ledger-report/bootstrap.js?v=31.0.04',
  './ledger-report/pack.js?v=31.0.04',
  './ledger-report/engines.js?v=31.0.04',
  './ledger-report/report.js?v=31.0.04',

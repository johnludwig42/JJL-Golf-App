const BUILD_INFO = {
  ...
  buildDate: '2026-09-07T18:00:00-04:00'
};
const CACHE_NAME = BUILD_INFO.cacheName;
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.40&rev=202609071800',
  './app.js?v=31.0.40&rev=202609071800',
  './identity-security.js?v=31.0.40&rev=202609071800',
  './supabase-config.js?v=31.0.40&rev=202609071800',
  './manifest.json?v=31.0.40&rev=202609071800',
  './branding/apple-touch-icon-v31.0.40.png',
  './branding/favicon-32-v31.0.40.png',
  './branding/favicon-16-v31.0.40.png',
  './branding/app-icon-192-v31.0.40.png',
  './branding/app-icon-512-v31.0.40.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.40',
  './ledger-report/pack.js?v=31.0.40',
  './ledger-report/engines.js?v=31.0.40',
  './ledger-report/logic.js?v=31.0.40',
  './ledger-report/report.js?v=31.0.40',

...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.09&rev=202608271600',
  './app.js?v=31.0.09&rev=202608271600',
  './identity-security.js?v=31.0.09&rev=202608271600',
  './supabase-config.js?v=31.0.09&rev=202608271600',
  './manifest.json?v=31.0.09&rev=202608271600',
  './branding/apple-touch-icon-v31.0.09.png',
  './branding/favicon-32-v31.0.09.png',
  './branding/favicon-16-v31.0.09.png',
  './branding/app-icon-192-v31.0.09.png',
  './branding/app-icon-512-v31.0.09.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.09',
  './ledger-report/pack.js?v=31.0.09',
  './ledger-report/engines.js?v=31.0.09',
  './ledger-report/report.js?v=31.0.09',

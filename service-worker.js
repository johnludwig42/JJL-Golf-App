...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=30.3.83&rev=4',
  './app.js?v=30.3.83&rev=4',
  './identity-security.js?v=30.3.83&rev=4',
  './supabase-config.js?v=30.3.83&rev=4',
  './manifest.json?v=30.3.83&rev=4',
  './branding/apple-touch-icon-v30.3.83.png',
  './branding/favicon-32-v30.3.83.png',
  './branding/favicon-16-v30.3.83.png',

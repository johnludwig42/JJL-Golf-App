...
const ASSETS = [
  './',
  './index.html',
  './style.css?v=31.0.29&rev=202609022300',
  './app.js?v=31.0.29&rev=202609022300',
  './identity-security.js?v=31.0.29&rev=202609022300',
  './supabase-config.js?v=31.0.29&rev=202609022300',
  './manifest.json?v=31.0.29&rev=202609022300',
  './branding/apple-touch-icon-v31.0.29.png',
  './branding/favicon-32-v31.0.29.png',
  './branding/favicon-16-v31.0.29.png',
  './branding/app-icon-192-v31.0.29.png',
  './branding/app-icon-512-v31.0.29.png',
  './ledger-report/shell.html',
  './ledger-report/bootstrap.js?v=31.0.29',
  './ledger-report/pack.js?v=31.0.29',
  './ledger-report/engines.js?v=31.0.29',
  './ledger-report/logic.js?v=31.0.29',
  './ledger-report/report.js?v=31.0.29',

...
test('Home Screen branding is shared by the header while install assets remain complete', () => {
  assert.match(html, /src="\.\/branding\/apple-touch-icon-v30\.3\.83\.png" alt="The Dye Ledger"/);
  assert.match(html, /href="\.\/branding\/apple-touch-icon-v30\.3\.83\.png"/);
  ...
  for (const asset of ['app-icon-192-v30.3.83.png', 'app-icon-512-v30.3.83.png', 'apple-touch-icon-v30.3.83.png', 'favicon-32-v30.3.83.png', 'favicon-16-v30.3.83.png']) {

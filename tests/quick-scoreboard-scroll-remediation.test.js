...
test('header, Apple, desktop PWA, favicon, worker cache, and branding documentation agree without changing artwork bytes', () => {
  ...
  const expected = [
    ['./branding/app-icon-192.png?v=30.3.75&rev=1', '192x192'],
    ['./branding/app-icon-512.png?v=30.3.75&rev=1', '512x512'],
  ...
  assert.match(worker, /cacheName: 'the-dye-ledger-v30\.3\.75'/);
  assert.match(htmlSource, /favicon-32\.png\?v=30\.3\.75&amp;rev=1/);
  assert.match(htmlSource, /favicon-16\.png\?v=30\.3\.75&amp;rev=1/);

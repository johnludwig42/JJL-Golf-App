...
test('RoundRecord fixtures preserve three-layer order, structured settlement, and legacy safety', () => {
  ...
  fixtures.forEach(fixture => {
    ...
    const order = ['The Dye Ledger', 'Round Story', 'Story of the Round', 'Round Analytics', 'Settlement', 'Game Drivers', 'Ledger / Audit Detail', 'Classic scorecard', 'Leaderboards'];
...
test('weather, out-of-sequence, legacy, and recap fixtures stay truthful and compact', () => {
  ...
  assert.match(weather.html, /Story of the Round/);
  assert.match(weather.html, /Saved Story/);

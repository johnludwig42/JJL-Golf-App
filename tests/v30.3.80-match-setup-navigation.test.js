...
test('post-v30.3.80 release identity retains immutable PWA assets', () => {
  ...
  assert.match(app, /versionNumber:\s*'30\.3\.96'/);
  assert.match(worker, /cacheName:\s*'the-dye-ledger-v30\.3\.96'/);
  ['app-icon-192-v30.3.96.png', 'app-icon-512-v30.3.96.png', 'apple-touch-icon-v30.3.96.png', 'favicon-32-v30.3.96.png', 'favicon-16-v30.3.96.png']

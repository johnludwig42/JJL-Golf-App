...
test('v30.3.80 release identity and immutable PWA assets are consistent', () => {
  assert.equal(pkg.version, '30.3.80');
  assert.equal(manifest.version, 'v30.3.80');
  assert.match(app, /versionNumber:\s*'30\.3\.80'/);
  assert.match(worker, /cacheName:\s*'the-dye-ledger-v30\.3\.80'/);
  ['app-icon-192-v30.3.80.png', 'app-icon-512-v30.3.80.png', 'apple-touch-icon-v30.3.80.png', 'favicon-32-v30.3.80.png', 'favicon-16-v30.3.80.png']

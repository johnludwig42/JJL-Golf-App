...
test('current metadata and immutable PWA assets remain consistent', () => {
  assert.equal(pkg.version, '30.3.93');
  assert.equal(manifest.version, 'v30.3.93');
  assert.match(app, /version: 'v30\.3\.93'/);
  for (const name of ['app-icon-192-v30.3.93.png', 'app-icon-512-v30.3.93.png', 'apple-touch-icon-v30.3.93.png', 'favicon-32-v30.3.93.png', 'favicon-16-v30.3.93.png']) {
...
test('More shows exactly the current and four preceding release notes', () => {
  ...
  assert.deepEqual(notes.map(note => note.version), ['v30.3.93', 'v30.3.92', 'v30.3.91', 'v30.3.90', 'v30.3.89']);
